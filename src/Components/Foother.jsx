...
export default function Foother() {
  return (
    <>
    <div className='mt-10 border-t border-gray-400 pt-4 flex justify-between items-center'>
        <h1 className='font-semibold font2 text-gray-500 text-3xl '><a href='mzee.dev'>&copy;mZeeDev</a></h1>
