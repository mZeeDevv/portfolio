...
export default function Header() {
  ...
  return (
    ...
    <div className='flex items-center md:space-x-96 md:max-w-5xl max-w-2xl mx-auto'>
    <h1 className='text-2xl lg:text-3xl font-bold md:inline font2 cursor-pointer hidden'>mZee.dev</h1>
    <ul className='flex md:space-x-10 w-full justify-center space-x-3 text-xs'>
